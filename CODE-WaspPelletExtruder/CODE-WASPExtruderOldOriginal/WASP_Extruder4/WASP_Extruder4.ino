...
*/      
      if(HeaterTempActual<HeaterTemp && !HeaterEnable && HeaterTemp>=0){
        HeaterEnable = true;
        digitalWrite(OutHeater, HeaterEnable);
        digitalWrite(OutFanTop, HeaterEnable);
...
boolean CMD (String inString){
  ...
  if (inChar == "S"){
    ...
    digitalWrite(OutFanBottom, FanEnable);
